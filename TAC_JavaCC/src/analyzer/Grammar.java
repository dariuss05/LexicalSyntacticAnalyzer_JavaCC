...
{if ("" != null) return 1;}
  ...
  static final public void relational() throws ParseException {
    sum();
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x520020,0xf600,0xf600,0x30000,0x30000,0xc0000,0xc0000,0x120020,0x120020,0x100020,};
	}
